    ...
    <div className="space-y-4 sm:space-y-6 w-full min-w-0">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
        ...
        <button 
          ...
          className="clay-button inline-flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-orange-500 to-amber-500 px-4 py-2.5 text-xs sm:text-sm font-bold text-white shadow-md hover:brightness-105 active:scale-95 transition-all shrink-0 cursor-pointer"
        >
          ...
          <div className="clay-card w-full max-w-lg p-5 sm:p-6 bg-white space-y-4 max-h-[92vh] overflow-y-auto no-scrollbar animate-scale-in">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs font-medium">
              ...
              <div className="flex items-center justify-end gap-2.5 pt-3 border-t border-slate-100">
                ...
                <button
                  type="submit"
                  className="clay-button inline-flex items-center gap-1.5 rounded-xl bg-gradient-to-r from-orange-500 to-amber-500 px-5 py-2 text-xs font-bold text-white shadow-md hover:brightness-105 active:scale-95 transition-all cursor-pointer"
                >
